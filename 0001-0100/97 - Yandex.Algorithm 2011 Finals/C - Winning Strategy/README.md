...
**Submission:** https://codeforces.com/contest/97/problem/C
...
More formally, suppose that the university sends a team to the k -th world finals. The team has a k participants of previous finals ( 0ΓÇëΓëñΓÇë a k ΓÇëΓëñΓÇë n ). Since each person can participate in the finals no more than twice, the following condition must be true: . Your task is to choose sequence so that the limit ╬¿ exists and it's value is maximal:
 
As is an infinite sequence, you should only print the maximum value of the ╬¿ limit.

## Input

The first line contains an integer n ( 3ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë100 ), n is the number of team participants. The second line contains n ΓÇë+ΓÇë1 real numbers with no more than 6 digits after decimal point p i ( 0ΓÇëΓëñΓÇë i ΓÇëΓëñΓÇë n ,ΓÇë0ΓÇëΓëñΓÇë p i ΓÇëΓëñΓÇë1 ) ΓÇö the probability of that the team will win a medal if it contains i participants who has already been on the finals. Also the condition p i ΓÇëΓëñΓÇë p i ΓÇë+ΓÇë1 should be fulfilled for all 0ΓÇëΓëñΓÇë i ΓÇëΓëñΓÇë n ΓÇë-ΓÇë1 .

## Output

Print the only real number ΓÇö the expected average number of medals won per year if the optimal strategy is used. The result may have absolute or relative error 10 ΓÇë-ΓÇë6 .
