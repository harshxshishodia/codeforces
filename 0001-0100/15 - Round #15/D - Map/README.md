...
The first line contains four space-separated integers: map sizes n , m and city sizes a , b ( 1ΓÇëΓëñΓÇë a ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë1000 , 1ΓÇëΓëñΓÇë b ΓÇëΓëñΓÇë m ΓÇëΓëñΓÇë1000 ). Then there follow n lines, each contains m non-negative space-separated numbers, describing the height matrix. Each number doesn't exceed 10 9 .

## Output

In the first line output k ΓÇö the amount of constructed cities. In each of the following k lines output 3 space-separated numbers ΓÇö the row number and the column number of the upper-left corner of a subsequent construction site, and the amount of the ground to remove from it. Output the sites in the order of their building up.
