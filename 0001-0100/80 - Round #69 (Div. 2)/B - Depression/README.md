...
**Submission:** https://codeforces.com/contest/80/problem/B
...
Print two numbers $$$x$$$ and $$$y$$$ ΓÇö the angles of turning the hour and minute hands, respectively ($$$0 \le x,y \lt 360$$$). The absolute or relative error in the answer should not exceed $$$10^{-9}$$$.
