...
**Submission:** https://codeforces.com/contest/77/problem/C

**Limits:** 3 seconds / 256 megabytes

## Problem Statement

"Eat a beaver, save a tree!" ΓÇö That will be the motto of ecologists' urgent meeting in Beaverley Hills. 
...
The first line contains integer n ΓÇö the number of vertices in the tree ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë10 5 ). The second line contains n integers k i ( 1ΓÇëΓëñΓÇë k i ΓÇëΓëñΓÇë10 5 ) ΓÇö amounts of beavers on corresponding vertices. Following n ΓÇë-ΓÇë1 lines describe the tree. Each line contains two integers separated by space. These integers represent two vertices connected by an edge. Vertices are numbered from 1 to n . The last line contains integer s ΓÇö the number of the starting vertex ( 1ΓÇëΓëñΓÇë s ΓÇëΓëñΓÇë n ).
