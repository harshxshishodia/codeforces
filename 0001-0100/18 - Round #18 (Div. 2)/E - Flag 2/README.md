...
**Submission:** https://codeforces.com/contest/18/problem/E

**Limits:** 2 seconds / 128 megabytes

## Problem Statement

According to a new ISO standard, a flag of every country should have, strangely enough, a chequered field n ΓÇë├ùΓÇë m , each square should be wholly painted one of 26 colours. The following restrictions are set: 
...
The first input line contains 2 integers n and m ( 1ΓÇëΓëñΓÇë n ,ΓÇë m ΓÇëΓëñΓÇë500 ) ΓÇö amount of rows and columns in Berland's flag respectively. Then there follows the flag's description: each of the following n lines contains m characters. Each character is a letter from a to z , and it stands for the colour of the corresponding square.
