...
**Submission:** https://codeforces.com/contest/94/problem/C
...
The only line contains four integers n , m , a , b ( 1ΓÇëΓëñΓÇë n ,ΓÇë m ΓÇëΓëñΓÇë10 9 , 1ΓÇëΓëñΓÇë a ΓÇëΓëñΓÇë b ΓÇëΓëñΓÇë n ). They are the number of folders in Igor K.'s computer, the width of a window and the numbers of the first and the last folders that need to be deleted.
...
In this test we can first select all folders in the first row (2, 3, 4, 5), then ΓÇö all other ones.
