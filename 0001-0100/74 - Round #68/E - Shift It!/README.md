...
**Submission:** https://codeforces.com/contest/74/problem/E

**Limits:** 2 seconds / 256 megabytes

## Problem Statement

There is a square box 6ΓÇë├ùΓÇë6 in size. It contains 36 chips 1ΓÇë├ùΓÇë1 in size. Those chips contain 36 different characters ΓÇö " 0 "-" 9 " and " A "-" Z ". There is exactly one chip with each character.
