...
**Submission:** https://codeforces.com/contest/62/problem/D
...
The first line contains two integers n and m ( 3ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë100,ΓÇë3ΓÇëΓëñΓÇë m ΓÇëΓëñΓÇë2000 ). It is the number of rooms and corridors in Arnie's house correspondingly. The next line contains m ΓÇë+ΓÇë1 positive integers that do not exceed n . They are the description of Arnie's old path represented as a list of rooms he visited during the gnawing. It is guaranteed that the last number in the list coincides with the first one.
