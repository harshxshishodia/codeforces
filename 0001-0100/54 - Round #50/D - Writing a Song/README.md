...
**Submission:** https://codeforces.com/contest/54/problem/D
...
The first line contains numbers N and K which are the length of the required string and the alphabet size accordingly. The limitations are: 1ΓÇëΓëñΓÇë N ΓÇëΓëñΓÇë100 , 2ΓÇëΓëñΓÇë K ΓÇëΓëñΓÇë26 .
...
The third line contains the string of length N ΓÇë-ΓÇë length ( P )ΓÇë+ΓÇë1 , consisting only of numbers zero and one. A number one in the i -th position means that an occurrence of the name P should start from i -th position of the desired word, while a zero means that there is no occurrence starting here.
