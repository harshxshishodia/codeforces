...
**Submission:** https://codeforces.com/contest/7/problem/E
...
One of the main problems arising while using macros ΓÇö the situation when as a result of substitution we get an arithmetic expression with the changed order of calculation because of different priorities of the operations.
...
The first line contains the only number n ( 0ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë100 ) ΓÇö the amount of #define constructions in the given program.
