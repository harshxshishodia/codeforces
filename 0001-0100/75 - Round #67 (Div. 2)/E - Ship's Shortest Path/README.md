...
**Submission:** https://codeforces.com/contest/75/problem/E
...
The first line contains 4 integers, xStart , yStart , xEnd and yEnd ( ΓÇë-ΓÇë100ΓÇëΓëñΓÇë xStart ,ΓÇë yStart ,ΓÇë xEnd ,ΓÇë yEnd ΓÇëΓëñΓÇë100 ). The second line contains an integer n , which is the number of points in the polygon ( 3ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë30 ), followed by a line containing n pairs of integers x and y , which are the coordinates of the points ( ΓÇë-ΓÇë100ΓÇëΓëñΓÇë x ,ΓÇë y ΓÇëΓëñΓÇë100 ), the polygon points will be distinct.

## Output

Print one line which contains the minimum possible cost. The absolute or relative error in the answer should not exceed 10 ΓÇë-ΓÇë6 .
