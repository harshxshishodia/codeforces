...
**Submission:** https://codeforces.com/contest/38/problem/B

**Limits:** 2 seconds / 256 megabytes

## Problem Statement

Two chess pieces, a rook and a knight, stand on a standard chessboard 8ΓÇë├ùΓÇë8 in size. The positions in which they are situated are known. It is guaranteed that none of them beats the other one.
