...
**Submission:** https://codeforces.com/contest/94/problem/A
...
Igor K. entered the ISQ from his additional account and looked at the info of his main one. His name and surname changed to "H1N1" and "Infected" correspondingly, and the "Additional Information" field contained a strange-looking binary code 80 characters in length, consisting of zeroes and ones. "I've been hacked" ΓÇö thought Igor K. and run the Internet Exploiter browser to quickly type his favourite search engine's address.
...
Print one line containing 8 characters ΓÇö The password to Igor K.'s ISQ account. It is guaranteed that the solution exists.
