...
**Submission:** https://codeforces.com/contest/98/problem/A
...
The first line contains exactly 6 characters without spaces from the set { R , O , Y , G , B , V } ΓÇö they are the colors of gems with which the box should be decorated.
