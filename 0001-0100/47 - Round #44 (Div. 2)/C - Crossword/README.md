...
**Submission:** https://codeforces.com/contest/47/problem/C

**Limits:** 2 seconds / 256 megabytes

## Problem Statement

Vasya trains to compose crossword puzzles. He can only compose crosswords of a very simpl╨╡ type so far. All of them consist of exactly six words; the words can be read only from top to bottom vertically and from the left to the right horizontally. The words are arranged in the form of a rectangular "eight" or infinity sign, not necessarily symmetrical.
...
Help Vasya ΓÇö compose a crossword of the described type using the given six words. It is allowed to use the words in any order.
