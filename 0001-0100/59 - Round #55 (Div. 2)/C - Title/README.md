...
**Submission:** https://codeforces.com/contest/59/problem/C
...
The first line contains an integer k ( 1ΓÇëΓëñΓÇë k ΓÇëΓëñΓÇë26 ) which is the number of allowed alphabet letters. The second line contains s which is the given template. In s only the first k lowercase letters of Latin alphabet and question marks can be present, the length of s is from 1 to 100 characters inclusively.
...
The lexicographical comparison is performed by the standard < operator in modern programming languages. The line a is lexicographically smaller than the line b , if exists such an i ( 1ΓÇëΓëñΓÇë i ΓÇëΓëñΓÇë| s | ), that a i ΓÇë<ΓÇë b i , and for any j ( 1ΓÇëΓëñΓÇë j ΓÇë<ΓÇë i ) a j ΓÇë=ΓÇë b j . | s | stands for the length of the given template.
