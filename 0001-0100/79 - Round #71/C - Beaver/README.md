...
**Submission:** https://codeforces.com/contest/79/problem/C
...
However, Ciel feels n strings b 1 ,ΓÇë b 2 ,ΓÇë... ,ΓÇë b n are really boring, and unfortunately she dislikes to remember a string that contains a boring substring. To make the thing worse, what she can remember is only the contiguous substring of s .
...
In the second line there is a single integer n ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë10 ). Next n lines, there is a string b i ( 1ΓÇëΓëñΓÇë i ΓÇëΓëñΓÇë n ). Each length of b i will be between 1 and 10 , inclusive.
...
Output in the first line two space-separated integers len and pos : the length of the longest contiguous substring of s that does not contain any b i , and the first position of the substring (0-indexed). The position pos must be between 0 and | s |ΓÇë-ΓÇë len inclusive, where | s | is the length of string s .
