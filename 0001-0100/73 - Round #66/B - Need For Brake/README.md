...
**Submission:** https://codeforces.com/contest/73/problem/B
...
The first line contains number n ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë10 5 ) ΓÇö number of racers. Each of the next n lines contains s i and a i ΓÇö nick of the racer (nonempty string, which consist of no more than 20 lowercase Latin letters) and the racer's points ( 0ΓÇëΓëñΓÇë a i ΓÇëΓëñΓÇë10 6 ). Racers are given in the arbitrary order.

The next line contains the number m ( 0ΓÇëΓëñΓÇë m ΓÇëΓëñΓÇë n ). Then m nonnegative integer numbers b i follow. i -th number is equal to amount of points for the i -th awarded place ( 0ΓÇëΓëñΓÇë b i ΓÇëΓëñΓÇë10 6 ).

The last line contains Vasya's racer nick.

## Output

Output two numbers ΓÇö the highest and the lowest place Vasya can take up as a result of the championship.
