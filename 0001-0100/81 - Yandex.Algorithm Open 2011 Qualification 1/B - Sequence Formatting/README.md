...
**Submission:** https://codeforces.com/contest/81/problem/B

**Limits:** 2 seconds / 256 megabytes

## Problem Statement

Polycarp is very careful. He even types numeric sequences carefully, unlike his classmates. If he sees a sequence without a space after the comma, with two spaces in a row, or when something else does not look neat, he rushes to correct it. For example, number sequence written like " 1,2┬á,3,...,┬á┬á┬á10 " will be corrected to " 1,┬á2,┬á3,┬á...,┬á10 ".
