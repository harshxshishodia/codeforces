...
**Submission:** https://codeforces.com/contest/93/problem/D
...
The only line contains two integers L and R ( 1ΓÇëΓëñΓÇë L ΓÇëΓëñΓÇë R ΓÇëΓëñΓÇë10 9 ). They are the lower and upper borders of the number of stripes on the flag.

## Output

Print a single number ΓÇö the number of different flags that would satisfy the condition of the problem and would have from L to R stripes, modulo 1000000007 .
...
That's why the answer to test 1 is equal to 11ΓÇë+ΓÇë12ΓÇë=ΓÇë23 .
