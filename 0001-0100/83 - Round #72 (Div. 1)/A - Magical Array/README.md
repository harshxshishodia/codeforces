...
**Submission:** https://codeforces.com/contest/83/problem/A
...
The first line of the input data contains an integer n ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë10 5 ). The second line contains an array of original integers a 1 ,ΓÇë a 2 ,ΓÇë...,ΓÇë a n ( ΓÇë-ΓÇë10 9 ΓÇëΓëñΓÇë a i ΓÇëΓëñΓÇë10 9 ).
