...
**Submission:** https://codeforces.com/contest/66/problem/E
...
The first line contains integer n ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë10 5 ). The second line contains n integers a i ΓÇö amount of gasoline on the i -th station. The third line contains n integers b 1 ,ΓÇë b 2 ,ΓÇë...,ΓÇë b n . They are the distances between the 1 -st and the 2 -nd gas stations, between the 2 -nd and the 3 -rd ones, ..., between the n -th and the 1 -st ones, respectively. The sum of all b i equals to the sum of all a i and is no more than 10 9 . Each of the numbers a i , b i is no less than 1 and no more than 10 9 .

## Output

Print on the first line the number k ΓÇö the number of possible post offices, from which the car can drive one circle along a circular road. Print on the second line k numbers in the ascending order ΓÇö the numbers of offices, from which the car can start.
