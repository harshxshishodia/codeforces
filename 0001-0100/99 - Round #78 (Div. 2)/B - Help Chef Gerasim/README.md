...
**Submission:** https://codeforces.com/contest/99/problem/B
...
The first line contains integer n ΓÇö the number of cups on the royal table ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë1000 ). Next n lines contain volumes of juice in each cup ΓÇö non-negative integers, not exceeding 10 4 .
