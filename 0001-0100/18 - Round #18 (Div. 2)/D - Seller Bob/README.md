...
**Submission:** https://codeforces.com/contest/18/problem/D
...
The first input line contains number n ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë5000 ) ΓÇö amount of Bob's working days. The following n lines contain the description of the days. Line sell x stands for a day when a customer came to Bob to buy a 2 x MB memory stick ( 0ΓÇëΓëñΓÇë x ΓÇëΓëñΓÇë2000 ). It's guaranteed that for each x there is not more than one line sell x . Line win x stands for a day when Bob won a 2 x MB memory stick ( 0ΓÇëΓëñΓÇë x ΓÇëΓëñΓÇë2000 ).
