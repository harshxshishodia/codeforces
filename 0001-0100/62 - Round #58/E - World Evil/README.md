...
**Submission:** https://codeforces.com/contest/62/problem/E
...
In this example n ΓÇë=ΓÇë4 , m ΓÇë=ΓÇë5 . Dotted lines are corridores that close each column to a ring, i. e. connect the n -th and the 1 -th rows of the grid.
...
The first line of the input file contains two integers n and m ( 2ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë5 , 2ΓÇëΓëñΓÇë m ΓÇëΓëñΓÇë10 5 ). They are the sizes of the Large Hadron Collider grid. The next m ΓÇë-ΓÇë1 lines contain n numbers each. They are the horizontal corridors' capacities. The next m lines contain n numbers each. They are the vertical corridors' capacities. Corridors are described from left to right and from top to bottom. Every n -th vertical corridor connects nodes of the n -th and 1 -th rows. A corridor's capacity is a non-negative integer that does not exceed 10 9 .
