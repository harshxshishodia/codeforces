...
**Submission:** https://codeforces.com/contest/87/problem/E
...
The first line contains an integer n , which represent the number of the polygon's vertexes ( 3ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë5┬╖10 4 ). Next n lines contain two integers x i , y i each, they are the coordinates of the polygon's i -th vertex in the counterclockwise order.

After the cities' description follows the integer m ( 1ΓÇëΓëñΓÇë m ΓÇëΓëñΓÇë10 5 ), which represents the number of hills. Next m lines each contain two integers x j , y j , they are the coordinates of the j -th hill.
...
For the hill at (2,ΓÇë1) the altars can be placed at the points (1,ΓÇë0),ΓÇë(7,ΓÇë5),ΓÇë(ΓÇë-ΓÇë2,ΓÇëΓÇë-ΓÇë2) , for the hill at (1,ΓÇë1) ΓÇö at the points (0,ΓÇë0),ΓÇë(6,ΓÇë4),ΓÇë(ΓÇë-ΓÇë3,ΓÇëΓÇë-ΓÇë1) . Many other groups of three points can do the trick. There are no suitable points for other hills.
