...
**Submission:** https://codeforces.com/contest/44/problem/B
...
The first line contains four integers ΓÇö n , a , b , c ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë10000 , 0ΓÇëΓëñΓÇë a ,ΓÇë b ,ΓÇë c ΓÇëΓëñΓÇë5000 ).

## Output

Print the unique number ΓÇö the solution to the problem. If it is impossible to buy exactly n liters of cola, print 0 .
