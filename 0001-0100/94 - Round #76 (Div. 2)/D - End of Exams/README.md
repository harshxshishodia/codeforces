...
**Submission:** https://codeforces.com/contest/94/problem/D
...
The only input data file contains three integers n , w and m ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë50 , 100ΓÇëΓëñΓÇë w ΓÇëΓëñΓÇë1000 , 2ΓÇëΓëñΓÇë m ΓÇëΓëñΓÇë50 ), where n stands for the number of ordered bottles, w stands for the volume of each of them and m stands for the number of friends in the company.
...
If there is a solution, then print m more lines, where the i -th of them describes the content of the i -th student's cup. The line should consist of one or more pairs that would look like " b v ". Each such pair means that v ( v ΓÇë>ΓÇë0 ) units of milk were poured into the i -th cup from bottle b ( 1ΓÇëΓëñΓÇë b ΓÇëΓëñΓÇë n ). All numbers b on each line should be different.
