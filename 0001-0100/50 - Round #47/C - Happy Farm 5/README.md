...
**Submission:** https://codeforces.com/contest/50/problem/C
...
The first line contains an integer N which represents the number of cows in the herd ( 1ΓÇëΓëñΓÇë N ΓÇëΓëñΓÇë10 5 ). Each of the next N lines contains two integers X i and Y i which represent the coordinates of one cow of ( | X i |,ΓÇë| Y i |ΓÇëΓëñΓÇë10 6 ). Several cows can stand on one point.

## Output

Print the single number ΓÇö the minimum number of moves in the sought path.
