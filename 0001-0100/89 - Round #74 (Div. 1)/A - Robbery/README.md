...
**Submission:** https://codeforces.com/contest/89/problem/A
...
Every minute the security system calculates the total amount of diamonds for each two adjacent cells (for the cells between whose numbers difference equals 1 ). As a result of this check we get an n ΓÇë-ΓÇë1 sums. If at least one of the sums differs from the corresponding sum received during the previous check, then the security system is triggered.
...
The first line contains integers n , m and k ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë10 4 , 1ΓÇëΓëñΓÇë m ,ΓÇë k ΓÇëΓëñΓÇë10 9 ). The next line contains n numbers. The i -th number is equal to the amount of diamonds in the i -th cell ΓÇö it is an integer from 0 to 10 5 .

## Output

Print a single number ΓÇö the maximum number of diamonds Joe can steal.
