...
**Submission:** https://codeforces.com/contest/84/problem/C
...
Of course, biathlon as any sport, proved very difficult in practice. It takes much time and effort. Workouts, workouts, and workouts, ΓÇö that's what awaited Valera on his way to great achievements in biathlon.
...
The first line of the input file contains the integer n ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë10 4 ), which is the number of targets. The next n lines contain descriptions of the targets. Each target is a circle whose center is located on the Ox axis. Each circle is given by its coordinate of the center x ( ΓÇë-ΓÇë2┬╖10 4 ΓÇëΓëñΓÇë x ΓÇëΓëñΓÇë2┬╖10 4 ) and its radius r ( 1ΓÇëΓëñΓÇë r ΓÇëΓëñΓÇë1000 ). It is guaranteed that no two targets coincide, intersect or are nested into each other, but they can touch each other. 

The next line contains integer m ( 1ΓÇëΓëñΓÇë m ΓÇëΓëñΓÇë2┬╖10 5 ), which is the number of shots. Next m lines contain descriptions of the shots, which are points on the plane, given by their coordinates x and y ( ΓÇë-ΓÇë2┬╖10 4 ΓÇëΓëñΓÇë x ,ΓÇë y ΓÇëΓëñΓÇë2┬╖10 4 ).
