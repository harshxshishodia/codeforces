...
**Submission:** https://codeforces.com/contest/45/problem/F
...
The first line contains two space-separated numbers m and n ( 1ΓÇëΓëñΓÇë m ,ΓÇë n ΓÇëΓëñΓÇë10 5 ) ΓÇö the number of animals and the boat's capacity.

## Output

If it is impossible to transport all the animals so that no one got upset, and all the goats survived, print -1. Otherwise print the single number ΓÇö how many times Vasya will have to cross the river.
