...
**Submission:** https://codeforces.com/contest/72/problem/B
...
Each line in INI-file stands for key-value mapping or defines new section. A key-value line has a format " key=value ",where key ΓÇö is the name of some property, and value ΓÇö it's value. It is possible that it will be spaces from the both sides of key and/or value , the spaces should be ignored.
...
Also you should ignore comment lines ΓÇö the first non-space character of comment line is " ; ".
...
The first line contains single integer n ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë510 ) ΓÇö the number of lines in given INI-file.
...
Each line has length not exceeding 255 characters and not less than 1 character. The total length of all the lines doesΓÇÖt exceed 10000.
