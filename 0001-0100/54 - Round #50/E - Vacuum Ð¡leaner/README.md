...
**Submission:** https://codeforces.com/contest/54/problem/E
...
The first line contains an integer N which represents the number of vertices of the vacuum cleaner's polygon ( 3ΓÇëΓëñΓÇë N ΓÇëΓëñΓÇë4┬╖10 4 ). Then follow N lines each containing two numbers ΓÇö the coordinates of a vertex of the polygon. All the coordinates are integer and their absolute values do not exceed 10 6 .
...
Print the minimum possible uncovered area. The answer will be accepted if it is within 10 ΓÇë-ΓÇë6 of absolute or relative error from the correct answer.
