...
**Submission:** https://codeforces.com/contest/72/problem/H

**Limits:** 4 seconds / 256 megabytes

## Problem Statement

The 14th of March was the international day of mathematics, because of number ╧ÇΓÇë=ΓÇë3.1415926.. .
...
Note, that if the integer is negative then its reverse would be also negative. For example reverse of ΓÇë-ΓÇë123 is ΓÇë-ΓÇë321 .
