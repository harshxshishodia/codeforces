...
**Submission:** https://codeforces.com/contest/84/problem/A
...
The input data consist of a single integer n ( 2ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë10 8 , n is even). Please note that before the game starts there are 2 n soldiers on the fields.

## Output

Print a single number ΓÇö a maximum total number of soldiers that could be killed in the course of the game in three turns.
