...
**Submission:** https://codeforces.com/contest/45/problem/G

**Limits:** 1 second / 256 megabytes

## Problem Statement

In Berland prime numbers are fashionable ΓÇö the respectable citizens dwell only on the floors with numbers that are prime numbers. The numismatists value particularly high the coins with prime nominal values. All the prime days are announced holidays!
...
The single input line contains an integer n ( 2ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë6000 ) ΓÇö the number of houses on the main streets of the capital.
