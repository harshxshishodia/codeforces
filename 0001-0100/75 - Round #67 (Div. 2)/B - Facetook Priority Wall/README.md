...
**Submission:** https://codeforces.com/contest/75/problem/B
...
The lexicographical comparison is performed by the standard " < " operator in modern programming languages. The line a is lexicographically smaller than the line b , if either a is the prefix of b , or if exists such an i ( 1ΓÇëΓëñΓÇë i ΓÇëΓëñΓÇë min (| a |,ΓÇë| b |) ), that a i ΓÇë<ΓÇë b i , and for any j ( 1ΓÇëΓëñΓÇë j ΓÇë<ΓÇë i ) a j ΓÇë=ΓÇë b j , where | a | and | b | stand for the lengths of strings a and b correspondently.
