...
**Submission:** https://codeforces.com/contest/72/problem/D

**Limits:** 7 seconds / 256 megabytes
...
- substr(x,a,b) gets a string x and two integers a and b ( 1ΓÇëΓëñΓÇë a ΓÇëΓëñΓÇë b ΓÇëΓëñΓÇë n , where n is the length of x ). And returns the substring of x between indexes a and b , inclusive. For example substr("Hello",2,4) returns "ell" . 
