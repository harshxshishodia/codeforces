...
**Submission:** https://codeforces.com/contest/8/problem/D
...
The first line contains two integers: t 1 ,ΓÇë t 2 ( 0ΓÇëΓëñΓÇë t 1 ,ΓÇë t 2 ΓÇëΓëñΓÇë100 ). The second line contains the cinema's coordinates, the third one ΓÇö the house's, and the last line ΓÇö the shop's. 
...
In the only line output one number ΓÇö the maximum distance that Alan and Bob will cover together, discussing the film. Output the answer accurate to not less than 4 decimal places.
