...
**Submission:** https://codeforces.com/contest/98/problem/D
...
The first line contains an integer n ΓÇö the number of disks ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë20 ). The second line contains n integers d i ΓÇö the disks' diameters after Ku Sean Sun cut their edges. The diameters are given from the bottom to the top ( 1ΓÇëΓëñΓÇë d i ΓÇëΓëñΓÇë20 , besides, d i ΓÇëΓëÑΓÇë d i ΓÇë+ΓÇë1 for any 1ΓÇëΓëñΓÇë i ΓÇë<ΓÇë n ).

## Output

Print on the first line number m ΓÇö the smallest number of moves to solve the gods' problem. Print on the next m lines the description of moves: two space-separated positive integers s i and t i that determine the number of the pillar from which the disk is moved and the number of pillar where the disk is moved, correspondingly ( 1ΓÇëΓëñΓÇë s i ,ΓÇë t i ΓÇëΓëñΓÇë3 , s i ΓÇëΓëáΓÇë t i ).
