...
**Submission:** https://codeforces.com/contest/37/problem/E
...
The first line contains two integers N and M ( 1ΓÇëΓëñΓÇë N ,ΓÇë M ΓÇëΓëñΓÇë50 ) ΓÇö the number of lines and columns on the slab. The next N lines contain M symbols each ΓÇö the final coloration of the slab. W stands for the square that should be painted white and B ΓÇö for the square that should be painted black.
