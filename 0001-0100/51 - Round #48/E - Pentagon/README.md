...
**Submission:** https://codeforces.com/contest/51/problem/E
...
The first line contains two integers n and m ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë700;0ΓÇëΓëñΓÇë m ΓÇëΓëñΓÇë n ┬╖( n ΓÇë-ΓÇë1)ΓÇë/ΓÇë2 ), where n represents the number of junctions and m is the number of roads in the city. Then follow m lines containing the road descriptions, one in each line. Every road is set by a number of integers a i ,ΓÇë b i ( 1ΓÇëΓëñΓÇë a i ,ΓÇë b i ΓÇëΓëñΓÇë n ; a i ΓÇëΓëáΓÇë b i ), where a i and b i represent the numbers of junctions, connected by the road. The junctions are numbered from 1 to n . It is not guaranteed that from any junction one can get to any other one moving along the roads.
