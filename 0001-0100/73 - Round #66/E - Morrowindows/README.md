...
**Submission:** https://codeforces.com/contest/73/problem/E
...
The first line contains two integers n and x ( 0ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë10 5 ,ΓÇë2ΓÇëΓëñΓÇë x ΓÇëΓëñΓÇë10 9 ). The second line contains integers a i ( 1ΓÇëΓëñΓÇë a i ΓÇëΓëñΓÇë10 9 ). Some numbers among all a i may be equal.

## Output

Output the fewest amount of modes required to uniquely determine amount of items in the inventory. If there is no solution output ΓÇë-ΓÇë1 .
