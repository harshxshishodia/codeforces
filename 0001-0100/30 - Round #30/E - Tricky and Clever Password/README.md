...
**Submission:** https://codeforces.com/contest/30/problem/E
...
The first line should contain integer k ΓÇö amount of nonempty parts of the password in your answer ( ). In each of the following k lines output two integers x i and l i ΓÇö start and length of the corresponding part of the password. Output pairs in order of increasing x i . Separate the numbers in pairs by a single space.
