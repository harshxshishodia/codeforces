...
**Submission:** https://codeforces.com/contest/91/problem/D
...
The first line contains an integer n ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë10 5 ). The second line contains n space-separated integers a i ( 1ΓÇëΓëñΓÇë a i ΓÇëΓëñΓÇë n ) ΓÇö the i -th number represents the number of a jar that occupies the i -th position. It is guaranteed that all the numbers are distinct.
...
On the first line of the description of one action indicate the number of jars that need to be taken ( k ), on the second line indicate from which positions the jars need to be taken ( b 1 ,ΓÇë b 2 ,ΓÇë...,ΓÇë b k ), on the third line indicate the jar's new order ( c 1 ,ΓÇë c 2 ,ΓÇë...,ΓÇë c k ). After the operation is fulfilled the jar from position b i will occupy the position c i . The set ( c 1 ,ΓÇë c 2 ,ΓÇë...,ΓÇë c k ) should be the rearrangement of the set ( b 1 ,ΓÇë b 2 ,ΓÇë...,ΓÇë b k ).
