...
**Submission:** https://codeforces.com/contest/40/problem/A

**Limits:** 2 seconds / 256 megabytes

## Problem Statement

Not so long ago as a result of combat operations the main Berland place of interest ΓÇö the magic clock ΓÇö was damaged. The cannon's balls made several holes in the clock, that's why the residents are concerned about the repair. The magic clock can be represented as an infinite Cartesian plane, where the origin corresponds to the clock center. The clock was painted two colors as is shown in the picture:
...
The first and single line contains two integers x and y ΓÇö the coordinates of the hole made in the clock by the ball. Each of the numbers x and y has an absolute value that does not exceed 1000 .
