...
When the ship reaches an inhabited planet, the inhabitants of the planet dissemble it, make n ΓÇë-ΓÇë2 identical to it ships with a hyperdrive and send them to other n ΓÇë-ΓÇë2 planets (except for the one from which the ship arrived). The time to make a new ship compared to the time in which they move from one planet to another is so small that it can be disregarded. New ships are absolutely identical to the ones sent initially: they move at the same constant speed along a straight line trajectory and, having reached a planet, perform the very same mission, i.e. are dissembled to build new n ΓÇë-ΓÇë2 ships and send them to all the planets except for the one from which the ship arrived. Thus, the process of spreading the important news around the galaxy continues.
...
The first line contains a number n ( 3ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë5000 ) ΓÇö the number of inhabited planets in the galaxy. The next n lines contain integer coordinates of the planets in format " x i y i z i " ( ΓÇë-ΓÇë10 4 ΓÇëΓëñΓÇë x i ,ΓÇë y i ,ΓÇë z i ΓÇëΓëñΓÇë10 4 ).

## Output

Print the single number ΓÇö the solution to the task with an absolute or relative error not exceeding 10 ΓÇë-ΓÇë6 .
