...
**Submission:** https://codeforces.com/contest/5/problem/E
...
The first line of the input data contains an integer number n ( 3ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë10 6 ), n ΓÇö the amount of hills around the capital. The second line contains n numbers ΓÇö heights of the hills in clockwise order. All height numbers are integer and lie between 1 and 10 9 .
