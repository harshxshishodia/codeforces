...
**Submission:** https://codeforces.com/contest/90/problem/A
...
The first line contains three integers r , g and b ( 0ΓÇëΓëñΓÇë r ,ΓÇë g ,ΓÇë b ΓÇëΓëñΓÇë100 ). It is guaranteed that r ΓÇë+ΓÇë g ΓÇë+ΓÇë b ΓÇë>ΓÇë0 , it means that the group consists of at least one student.

## Output

Print a single number ΓÇö the minimal time the students need for the whole group to ascend to the top of the mountain.
