...
**Submission:** https://codeforces.com/contest/78/problem/C
...
The first line contains three integers n , m , k ( 1ΓÇëΓëñΓÇë n ,ΓÇë m ,ΓÇë k ΓÇëΓëñΓÇë10 9 ).
...
In the first sample the beavers only have one log, of 15 meters in length. Timur moves first. The only move he can do is to split the log into 3 parts each 5 meters in length. Then Marsel moves but he can't split any of the resulting logs, as k ΓÇë=ΓÇë4 . Thus, the winner is Timur.
