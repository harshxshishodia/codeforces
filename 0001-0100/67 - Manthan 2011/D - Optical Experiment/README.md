...
**Submission:** https://codeforces.com/contest/67/problem/D
...
The first line contains n ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë10 6 ), the number of rays. The second line contains n distinct integers. The i -th integer x i ( 1ΓÇëΓëñΓÇë x i ΓÇëΓëñΓÇë n ) shows that the x i -th ray enters from the i -th hole. Similarly, third line contains n distinct integers. The i -th integer y i ( 1ΓÇëΓëñΓÇë y i ΓÇëΓëñΓÇë n ) shows that the y i -th ray exits from the i -th hole. All rays are numbered from 1 to n .
