...
**Submission:** https://codeforces.com/contest/88/problem/C
...
The first line contains two integers a and b ( a ΓÇëΓëáΓÇë b ,ΓÇë1ΓÇëΓëñΓÇë a ,ΓÇë b ΓÇëΓëñΓÇë10 6 ).
...
Let's take a look at the third sample. Let the trains start to go at the zero moment of time. It is clear that the moments of the trains' arrival will be periodic with period 6. That's why it is enough to show that if Vasya descends to the subway at a moment of time inside the interval (0,ΓÇë6] , he will go to both girls equally often. 
...
In sum Masha and Dasha get equal time ΓÇö three minutes for each one, thus, Vasya will go to both girlfriends equally often.
