...
The first input line contains an integer n ( 1ΓÇëΓëñΓÇë n ΓÇëΓëñΓÇë3000 ) which is the number of marbles. The next n lines contain the descriptions of the marbles in pairs of integers x i , c i ( ΓÇë-ΓÇë10 9 ΓÇëΓëñΓÇë x i ,ΓÇë c i ΓÇëΓëñΓÇë10 9 ). The numbers are space-separated. Each description is given on a separate line. No two marbles have identical initial positions.

## Output

Output the single number ΓÇö the least fine you will have to pay.
